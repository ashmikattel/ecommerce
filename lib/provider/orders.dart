...
class Orders with ChangeNotifier {
  ...
  Future<void> fetchAndSetOrders() async {
    final url = 'https://flutter-update-1a6cb.firebaseio.com/orders.json?auth=$authToken';
  ...
  // }
  Future<void> deleteOrders({String id}) async {
    final url = 'https://flutter-update-1a6cb.firebaseio.com/orders/$id.json?auth=$authToken';
    final existingOrderIndex = orders.indexWhere((ord) => ord.id == id);
